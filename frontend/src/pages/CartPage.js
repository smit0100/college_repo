...
const CartPage = () => {
  return (
    <>
      <div className="w-full pb-10 relative mx-auto z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
