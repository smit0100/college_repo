...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" border-gray-200  py-2.5  dark:bg-gray-900 z-10 relative w-[96.50vw] sm:w-[98.5vw] bg-inherit ">
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul className="flex flex-col p-4 mt-4 border rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 ">
              ...
              <li>
                ...
                <Link to='cartpage' className="block py-2 pl-3 pr-4 rounded text-white text-lg">
                  <i className="fa-sharp fa-solid fa-bag-shopping pr-3"></i>
                  cart 
                </Link>
              </li>
            </ul>
